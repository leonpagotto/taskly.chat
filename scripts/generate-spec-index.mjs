...
const OUTPUT = path.resolve(process.cwd(), 'docs/SPEC-INDEX.md');
...
async function main() {
  ...
  const lines = [];
  lines.push('# Specification Index');
  lines.push('Generated: ' + new Date().toISOString());
  lines.push('');
  lines.push('## Project Overview');
  lines.push('');
  lines.push('- [Taskly.Chat (v1.0.0)](./PROJECT_OVERVIEW.md)');
  lines.push('');
  ...
  lines.push('## Notes');
  lines.push('');
  lines.push('- Auto-generated by scripts/generate-spec-index.mjs');
  lines.push('- Includes backlog counts and pipeline snapshot');
