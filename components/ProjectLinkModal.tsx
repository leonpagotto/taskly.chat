          ...
          <ul className="space-y-1">
            <li>
              <button
                ...
                className={`w-full text-left p-3 rounded-md flex items-center gap-3 transition-colors ${!currentProjectId ? 'bg-[var(--color-primary-600)]/30' : 'hover:bg-gray-700'}`}
              >
              ...
              return (
                <li key={project.id}>
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-md flex items-center gap-3 transition-colors ${currentProjectId === project.id ? 'bg-[var(--color-primary-600)]/30' : 'hover:bg-gray-700'}`}
                  >
                    {category ? (
